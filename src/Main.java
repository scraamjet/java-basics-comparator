...
public class Main {
    ...
    System.out.println("Choose a Comparator of your choice and color from the suggested:\n1 - " +
            "NameComparator\n2 - AgeComparator\n3 - CourseComparator");
    byte a = scanner.nextByte();
    switch (a){
        case 1:{
            System.out.println("Sorting students alphabetically by name: ");
        ...
        case 3:{
            System.out.println("Sorting students by course in descending order: ");
